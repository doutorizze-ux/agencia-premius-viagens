...
async function renderWhatsApp() {
  ...
  const statusText = connected ? 'Número conectado e pronto para atender' : wa.status === 'error' ? 'Não foi possível iniciar o Baileys' : wa.mode === 'demo' ? 'Modo demonstração · pronto para testar' : 'Aguardando conexão';
